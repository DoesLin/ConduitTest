...
public class ConnAdminRessourcesInteTest {
    ...
    @Test
    public void test1ConnexionAdminRessourcesDesAutres() {
        try {
    ...
    @Test
    public void test2ConnexionAdminRessources() {
        try {
            setSecurityContext(chefMagasin);
    ...
    @Test
    public void test3ConnexionAdminRessourcesIncorrecte() {
        try {
            setSecurityContext(chefMagasin);
            vendeurWS.create(vendeurIncorrect);
            Assert.fail("Exception should be thrown");
        } catch (Exception e) {
